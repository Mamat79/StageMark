...
**Version disponible : build 6**, bouton de relevé corrigé, visée clarifiée et tolérance après accord explicite. [Téléchargements actuels, SHA-256 et limites](RELEASE_NOTES_AR_BUILD6.md). Les notes build 3 ci-dessous sont historiques, leurs empreintes ne sont plus celles de l’asset 0.1.1 remplacé.
